...
# file_path = os.path.join(images_path,"/home/whc/aiui_ws/calib_data/20250617/poses.txt")  #采集标定板图片时对应的机械臂末端的位姿 从 第一行到最后一行 需要和采集的标定板的图片顺序进行对应

images_path = "/home/whc/aiui_ws/calib_data/20250617"

file_path = "/home/whc/aiui_ws/calib_data/20250617/poses.txt"



with open("/home/whc/aiui_ws/src/aiui/hand_eye_calibration/config.yaml", 'r', encoding='utf-8') as file:
...
def func():
    ...
    csv_file = "/home/whc/aiui_ws/RobotToolPose.csv"
